...
#PARTE DEL CODIGO ANTERIOR / AHORA ESTOS ESTAN EN FUNCIONES 
'''
    def actualizar_evento(self, event=None):
        self.funciones.actualizar()

    def salir_evento(self, event):
        self.ventana.quit()

    def mostrar_ayuda_evento(self, event=None):
        self.funciones.mostrar_ayuda()
